...
import Repositorio.SubcategoriaFacade;
...
@Named("subcategoriaController")
@SessionScoped
public class SubcategoriaController implements Serializable {

    private Subcategoria current;
    private DataModel items = null;
    @EJB
    private Repositorio.SubcategoriaFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Subcategoria) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("SubcategoriaCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("SubcategoriaUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("SubcategoriaDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Subcategoria getSubcategoria(java.lang.Short id) {
    ...
    public static class SubcategoriaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Subcategoria) {
                ...
                return getStringKey(o.getCodSubcategoria());
            } else {
