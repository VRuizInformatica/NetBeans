...
import Repositorio.TecnicoFacade;
...
public class TecnicoController implements Serializable {
    ...
    @EJB
    private Repositorio.TecnicoFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Tecnico) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("TecnicoCreated"));
    ...
    public static class TecnicoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Tecnico) {
                ...
                return getStringKey(o.getCodTecnico());
            } else {
