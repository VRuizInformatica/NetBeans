...
import Repositorio.CategoriaFacade;
...
public class CategoriaController implements Serializable {
    ...
    @EJB
    private Repositorio.CategoriaFacade ejbFacade;
    ...
    public Categoria getCategoria(java.lang.Short id) {
    ...
    public static class CategoriaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Categoria) {
                ...
                return getStringKey(o.getCodCategoria());
            } else {
